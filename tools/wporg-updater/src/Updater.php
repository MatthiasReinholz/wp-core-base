...
final class Updater
{
    ...
    public static function labelDefinitions(): array
    {
        return [
            ...
            'source:acf-pro' => ['color' => '0f766e', 'description' => 'Update sourced from ACF PRO vendor updates'],
            'source:role-editor-pro' => ['color' => 'b45309', 'description' => 'Update sourced from User Role Editor Pro vendor updates'],
            'source:freemius-premium' => ['color' => '7c3aed', 'description' => 'Update sourced from Freemius premium updates'],
