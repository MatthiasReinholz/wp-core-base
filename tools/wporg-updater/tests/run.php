...
$suites = new SuiteRunner(__DIR__ . '/integration', [
    ...
    'runtime_compatibility_contracts.php' => 'run_runtime_compatibility_contract_tests',
...
$suites->run('runtime_compatibility_contracts.php', static fn () => run_runtime_compatibility_contract_tests($assert, $repoRoot));
